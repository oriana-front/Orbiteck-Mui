...
export default function CustomPaginationActionsTable() {
  ...
  return (
    <>
    <DrawerHeader/>
    <Typography variant='h5' margin={1}>REPORTES GUARDADOS (plantillas)</Typography>
     {/*BUSCADOR*/}
          ...
          {(rowsPerPage > 0
            ...
            <TableRow key={row.nombre}>
              ...
              <TableCell  align="right">
                { [ 
                <Build sx={{marginRight:1}} onClick={ (event,row)=>{alert("Has precionado el botòn ajustar")}}/>,
                <Edit sx={{marginRight:1}} onClick={ (event,row)=>{alert("Has precionado el botòn editar")}}/>,
                <Delete  onClick={ (event,row)=>{alert("Estas seguro que quieres eliminar este reporte")}}/>,
